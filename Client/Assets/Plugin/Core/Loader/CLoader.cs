	...
	IEnumerator Loadres()
	{
		...
		}else
		{
            ...
            if (req.isShared)
            {
                ...
                // asset = null;
               // AssetBundleCreateRequest ab = AssetBundle.CreateFromMemory(www.bytes);
               // yield return ab;
               // req.data = ab;
               //var aseet= ab.assetBundle.mainAsset;
#if UNITY_EDITOR
...
//                www.Dispose();
	...
	private void BeginLoadDependencies(CDependencies script)
	{
