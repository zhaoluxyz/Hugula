...
function StateManager:onItemObjectAssetsLoaded(itemObj)
   if (itemObj==nil or itemObj.name ~= self.m_transform.name) then   StateManager.m_objectLoaded=StateManager.m_objectLoaded+1 end
     -- print("OnObjectShowed m_objectLoaded: "..CStateManager.m_objectLoaded.." m_objectCount:"..CStateManager.m_objectCount)
